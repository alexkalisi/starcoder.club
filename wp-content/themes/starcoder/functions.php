...
define( 'IMAGES_FOLDER', get_stylesheet_directory_uri() . '/assets/images/' );
...
function show_custom_logo( $position = "header" ,$size = 'medium' ) {
...
/*******************************************************************************/
include_once get_stylesheet_directory() . '/inc/ajax-load.php';
...
function custom_reviews( $comment, $args, $depth ){

	?><div class="large-4 medium-6 small-12 section_six_reviews-item" id="review-<?php comment_ID() ?>">
			<div class="section_six_review-wrapper">
				<span class="section_six_reviews-item-date"><?php date_i18n(comment_date( 'j F Y' )); ?></span>
				<span class="section_six_reviews-item-name"><?php comment_author() ?></span>
				<div class="section_six_reviews-item-stars">
					<?php
						$rating = get_rating_by_comment_author_url_field();
				...
				<div class="section_six_reviews-item-review"><?php comment_text() ?></div>
			</div>
		<?php
}

function custom_reviews_end( $comment, $args, $depth ){
	echo '</div>';
}
...
function get_rating_by_comment_author_url_field( $comment_ID = 0 ) {
